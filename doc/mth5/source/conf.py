...
latex_documents = [
    (master_doc, 'MTHotel.tex', 'MTHotel',
     'Dr. Bernhard Friedrichs', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'MTHotel', 'MTHotel',
     author, 'MTHotel', 'One line description of project.',
     'Miscellaneous'),
]
