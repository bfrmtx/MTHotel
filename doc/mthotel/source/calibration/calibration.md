...
in old manuals the equations were written like<br>
$P_{4} = i \cdot \frac{f}{\frac{0.159}{(R_{sensor} + 200) \cdot 7.27E^{-9}Hz}}$ <br>
$P_{4} = i \cdot \frac{f}{\frac{0.159}{(R_{sensor} + 200) \cdot 470E^{-12}Hz}}$ <br>
...
phase below 0.1 Hz for the MFS-06e and $\frac{20  mV}{nT \cdot Hz}$ and 90° for the MFS-07e. <br>
