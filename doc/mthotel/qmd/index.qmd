...
However the [atss](atss/atss.qmd#atss) data stream and his JSON descriptor are designed to be pushed into the MTH5 format.
...
Follow the main [imprint](https://www.metronix.de/impressum). <br>
On this page adobe sans pro font is used for documenting this open source project.