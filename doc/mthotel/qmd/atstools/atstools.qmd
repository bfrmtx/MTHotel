...
From an existing **procmt** directory structure a new [HDF5-Tree](../HDF5-Tree/HDF5-Tree.qmd#hdf5-tree) is created. <br>
Old ats files appear as [atss](../atss/atss.qmd#atss) files and the atsheader is converted to a [JSON header](../atss/atss.qmd#header).
...
Refer also to [chcal](../chcal/chcal.qmd#chcal) for the calibration files. The (possible) input of 
