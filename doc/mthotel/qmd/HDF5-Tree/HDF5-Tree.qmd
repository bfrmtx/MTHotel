...
For distributed data recording and frequent data changes it is *not* made. The [ **atss**](../atss/atss.qmd#atss) and **JSON** files of the metronix data loggers are that way organized that the can be finally pushed into the MTH5 HDF5 format.
