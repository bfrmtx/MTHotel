...
The directory tree [HDF5](../HDF5-Tree/HDF5-Tree.qmd#hdf5-tree) is the same / similar as in the *MTH5 survey*. <br>
...
- id: text string, e.g. "AXB L22 S123", no processing for that, typically set during acquisition
...
For the electric field *without* calibration the entries for f, a, p are there but empty.<br>
**id** is a string. Normally set during acquisition. Typically "AXB L22 S123" No processing for that.<br>
If your directory is stations/Sarıçam/run_110 this entry has no effect.
