...
public:
  ...
  inline std::vector<std::uint8_t> to_cbor(const basic_json &j) {
  ...
  inline std::vector<std::uint8_t> to_msgpack(const basic_json &j) {
    std::vector<std::uint8_t> result;
    to_msgpack(j, result);
    return result;
  }
  ...
  inline std::vector<std::uint8_t> to_ubjson(const basic_json &j,
  ...
  inline std::vector<std::uint8_t> to_bjdata(const basic_json &j,
                                             const bool use_size = false,
                                             const bool use_type = false,
  ...
  inline std::vector<std::uint8_t> to_bson(const basic_json &j) {
    std::vector<std::uint8_t> result;
    to_bson(j, result);
    return result;
  }
