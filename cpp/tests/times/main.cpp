...
*/
    ...
    std::cout << std::endl;
    std::cout << "channel time end check" << std::endl << std::endl;
    ...
    for (const auto &us : use_secs) {
        ...
        std::cout << "stop time: " << chans.back()->stop_datetime(0) << std::endl << std::endl;

    }
    std::cout << std::endl;

    std::cout << "channel time start check" << std::endl << std::endl;
